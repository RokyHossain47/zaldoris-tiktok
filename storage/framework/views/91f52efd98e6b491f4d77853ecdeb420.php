...
<header class="zal-navbar">
    <div class="zal-navbar-inner">
        ...
        <a class="zal-brand" href="<?php echo e(route('home')); ?>">
            <img src="<?php echo e(asset('assets/logo.png')); ?>" alt="Zaldoris" class="zal-brand-logo">
        </a>
    ...
    <div class="room-layout-grid">
        ...
        <aside class="room-left-card">
            ...
            <div class="room-back-btn-wrap">
                <a href="<?php echo e(route('home')); ?>" class="auth-back-btn" title="Back to Home">
            ...
            <div class="room-host-section">
                <div class="host-avatar-wrap">
                    <img src="<?php echo e($hostAvatar); ?>" alt="<?php echo e($hostName); ?>" class="host-avatar-img">
                    <span class="badge-host-pill">Host</span>
                </div>
                <h1 class="room-host-name"><?php echo e($hostName); ?></h1>
                <div class="room-host-rating">
                    <i class="bi bi-star-fill"></i>
                    <span>4.9 (1.2k reviews)</span>
                </div>
                <div class="room-host-followers"><?php echo e(number_format($followerCount)); ?> Followers</div>
                <button type="button" class="btn-follow-cyan <?php echo e($isFollowing ? 'following' : ''); ?>" data-user-id="<?php echo e($hostUserId); ?>" onclick="toggleCreatorFollow(this, <?php echo e($hostUserId); ?>)">
            ...
            <div class="room-product-box">
                ...
                <div class="product-action-row">
                    <a href="<?php echo e(route('shop.product', $pinnedProduct->id ?? 1)); ?>" class="btn-outline-cyan" style="text-decoration:none; display:inline-flex; align-items:center; justify-content:center;">Details</a>
                    <button type="button" class="btn-solid-cyan" onclick="addCartItem(<?php echo e($pinnedProduct->id ?? 1); ?>, '<?php echo e(addslashes($pinnedProduct->title ?? 'Featured Drop')); ?>', this)">Add To Cart</button>
                </div>
            </div>
        </aside>
...
<footer class="zal-footer-center">
    <div class="container">
        ...
        <a href="<?php echo e(route('home')); ?>">
            <img src="<?php echo e(asset('assets/logo.png')); ?>" alt="Zaldoris" class="footer-logo-img">
        </a>
...
<?php /**PATH C:\wamp64\www\zaldoris-tiktok\resources\views/streams/live_shopping.blade.php ENDPATH**/ ?>