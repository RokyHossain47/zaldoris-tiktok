...
<head>
    ...
    <meta name="description" content="<?php echo e(Str::limit($product->description ?? 'Zaldoris Product Details. View specifications, sizes, colors, and direct purchase system.', 160)); ?>">
    <title><?php echo e($product->title ?? 'Product Details'); ?> - <?php echo e(setting('site_name', 'Zaldoris Live Commerce Platform')); ?></title>
    <!-- Favicon -->
        ...
        <div class="zal-nav-actions">
            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                <a href="<?php echo e(route('shop.cart')); ?>" class="nav-icon-btn" title="Cart">
                    ...
                    <span class="icon-badge-num" id="globalCartBadge"><?php echo e(array_sum(array_column(session('cart', []), 'quantity')) ?: 0); ?></span>
                </a>
...
<main class="product-page-wrapper">
    ...
    <nav class="zal-breadcrumb-nav" aria-label="breadcrumb">
        <a href="<?php echo e(route('home')); ?>"><i class="bi bi-house-door"></i> Home</a>
        <i class="bi bi-chevron-right"></i>
        <a href="<?php echo e(route('shop.index')); ?>"><?php echo e($product->category_name ?? 'Shop'); ?></a>
        <i class="bi bi-chevron-right"></i>
        <span class="active"><?php echo e(Str::limit($product->title, 40)); ?></span>
    </nav>
    ...
    <div class="product-details-grid">
        ...
        <div class="product-gallery-box">
            ...
            <div class="main-image-wrap">
                <div class="gallery-badge-overlay">
                    <?php if($discountPercent > 0): ?>
                        <span class="badge-discount-tag"><?php echo e($discountPercent); ?>% OFF</span>
                    <?php endif; ?>
                    <span class="badge-stock-tag">
                        <i class="bi bi-check-circle-fill"></i> In Stock (<?php echo e($product->available_stock > 0 ? $product->available_stock : 12); ?> Left)
                    </span>
                </div>
                <button type="button" class="btn-wishlist-float" id="btnWishlist" title="Save to Wishlist" onclick="toggleWishlist(this)">
                    <i class="bi bi-heart"></i>
                </button>
                <img src="<?php echo e($mainImg); ?>" alt="<?php echo e($product->title); ?>" id="mainGalleryImg" class="main-image-display">
            </div>

            <!-- Thumbnails Row -->
            <div class="product-thumbs-row">
                <?php $__currentLoopData = $galleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $imgUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="product-thumb-item <?php echo e($index === 0 ? 'active' : ''); ?>" onclick="switchMainImage(this, '<?php echo e($imgUrl); ?>')">
                        <img src="<?php echo e($imgUrl); ?>" alt="Thumb <?php echo e($index + 1); ?>">
                    </div>
            ...
            <div class="trust-guarantee-box">
                ...
                <div class="trust-item">
                    ...
                    <span>Free Shipping over <?php echo e($currency); ?>50</span>
                </div>
                <div class="trust-item">
        ...
        <div class="product-info-card">
            ...
            <div class="product-category-row">
                <span class="product-badge-cat"><?php echo e($product->category_name ?? 'Electronics & Goods'); ?></span>
                <span class="product-sku-text">SKU: ZAL-<?php echo e($product->id ? str_pad($product->id, 4, '0', STR_PAD_LEFT) : '8921'); ?>-X</span>
            </div>

            <!-- Title -->
            <h1 class="product-main-title" id="productTitle"><?php echo e($product->title); ?></h1>

            <!-- Ratings & Order count -->
            <div class="product-rating-overview">
                <div class="stars-group">
                    <?php for($i = 1; $i <= 5; $i++): ?>
                        <?php if($i <= round($displayAvgRating)): ?>
                ...
                <span class="rating-num-val"><?php echo e($displayAvgRating); ?></span>
                <span class="reviews-count-link" onclick="scrollToReviews()">(<?php echo e(number_format($displayReviewsCount)); ?> <?php echo e(isset($totalReviews) && $totalReviews > 0 ? 'Customer' : 'Verified'); ?> Reviews)</span>
                <span class="orders-count-badge"><i class="bi bi-bag-check-fill"></i> <?php echo e($product->locked_stock > 0 ? $product->locked_stock : '3.4k'); ?> Sold</span>
            </div>

            <!-- Pricing Box -->
            <div class="product-price-section">
                <div class="price-left-box">
                    <span class="price-main-val" id="productPriceDisplay"><?php echo e($currency); ?><?php echo e(number_format($defaultSizePrice, 2)); ?></span>
                    <?php if($comparePrice > $price): ?>
                        <span class="price-original-strike" id="productOldPriceDisplay"><?php echo e($currency); ?><?php echo e(number_format($comparePrice, 2)); ?></span>
                    <?php endif; ?>
                </div>
                <?php if($saveAmount > 0): ?>
                    <span class="save-badge-pill" id="productSaveBadge">Save <?php echo e($currency); ?><?php echo e(number_format($saveAmount, 2)); ?> (<?php echo e($discountPercent); ?>% OFF)</span>
                <?php endif; ?>
            </div>

            <!-- Notice: Distinction Between Static Product & Live Shopping Room -->
            <?php if(isset($stream) && $stream): ?>
                <div class="live-stream-notice-box">
                    ...
                    <a href="<?php echo e(route('streams.show', $stream->id)); ?>" class="btn-link-live-room">
            ...
            <div class="seller-profile-row">
                <div class="seller-profile-left">
                    <img src="<?php echo e($sellerAvatar); ?>" alt="<?php echo e($sellerName); ?>" class="seller-avatar-img">
                    <div class="seller-meta-info">
                        <div class="seller-name-row">
                            <span id="sellerName"><?php echo e($sellerName); ?></span>
                            <i class="bi bi-patch-check-fill text-info" title="Verified Creator & Seller"></i>
                        </div>
                        <span class="seller-feedback-text">
                            <?php if($seller && $seller->creatorProfile): ?>
                                <?php echo e(number_format($seller->creatorProfile->total_followers ?? 0)); ?> Followers &bull; 98% Positive Feedback
                            <?php else: ?>
                ...
                <button type="button" class="btn-outline-follow <?php echo e($isFollowing ? 'following' : ''); ?>" id="btnFollowSeller" onclick="toggleFollowSeller(this, <?php echo e($seller ? $seller->id : 0); ?>)">
            ...
            <div class="mb-4">
                <p style="color: #CBD5E1; font-size: 0.9rem; line-height: 1.6; margin: 0;">
                    <?php echo e($product->description ?: 'Professional grade finish, equipped with the latest high-performance processing unit. Experience the future of shopping with premium craftsmanship and exceptional durability.'); ?>

                </p>
            </div>

            <!-- Variant Selector: Size / Model -->
            <?php if(count($sizesList) > 0): ?>
            <div class="select-size-section">
                <div class="product-section-heading">
                    <span>Select Size / Model Variant</span>
                    <span class="selected-variant-val" id="selectedSizeText"><?php echo e($defaultSize); ?></span>
                </div>
                <div class="size-radio-group">
                    <?php $__currentLoopData = $sizesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $modPrice = $price + ($size['price_modifier'] ?? 0);
                        ?>
                        <label class="size-radio-label <?php echo e($index === 0 ? 'active' : ''); ?>" onclick="selectProductSize('<?php echo e(addslashes($size['name'])); ?>', <?php echo e($modPrice); ?>, this)">
                            <input type="radio" name="productSize" <?php echo e($index === 0 ? 'checked' : ''); ?>>
                            <span><?php echo e($size['name']); ?> <?php if(($size['price_modifier'] ?? 0) > 0): ?> (+<?php echo e($currency); ?><?php echo e(number_format($size['price_modifier'], 2)); ?>) <?php endif; ?></span>
                        </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="select-color-section">
                <div class="product-section-heading">
                    ...
                    <span class="selected-variant-val" id="selectedColorText"><?php echo e($defaultColor); ?></span>
                </div>
                <div class="color-swatch-group">
                    <?php $__currentLoopData = $colorsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button" 
                            class="color-swatch-btn <?php echo e($index === 0 ? 'active' : ''); ?>" 
                            style="background: <?php echo e($color['code'] ?? '#1E293B'); ?>;" 
                            title="<?php echo e($color['name']); ?>" 
                            onclick="selectProductColor('<?php echo e(addslashes($color['name'])); ?>', this)">
                        </button>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="quantity-subtotal-row">
                ...
                <div class="calculated-subtotal-box">
                    ...
                    <div class="subtotal-val" id="productSubtotalDisplay"><?php echo e($currency); ?><?php echo e(number_format($defaultSizePrice, 2)); ?></div>
                </div>
            </div>

            <!-- Static Purchase Action Buttons -->
            <div class="product-buy-actions">
                <button type="button" class="btn-add-cart-outline" onclick="handleAddToCart(<?php echo e($product->id ?? 1); ?>)">
                    <i class="bi bi-cart-plus-fill"></i> Add To Cart
                </button>
                <button type="button" class="btn-buy-now-cyan" onclick="handleBuyNow(<?php echo e($product->id ?? 1); ?>)">
    ...
    <section class="product-tabs-container" id="productTabsContainer">
        ...
        <div class="nav-tabs-custom">
            ...
            <button class="tab-btn-pill" onclick="switchProductTab('reviews', this)" id="tabReviewsBtn">Customer Reviews (<?php echo e(number_format($displayReviewsCount)); ?>)</button>
        ...
        <div class="tab-pane-content active" id="tab-overview">
            ...
            <p style="color: #CBD5E1; line-height: 1.7; margin-bottom: 20px;">
                <?php echo e($product->description ?: 'Engineered with top-tier materials and rigorous craftsmanship, this product is built for relentless endurance and pristine aesthetics. Tested under demanding real-world conditions to provide a superior user experience.'); ?>
            ...
            <div style="background: #090D10; border: 1px solid var(--p-card-border); border-radius: 14px; overflow: hidden;">
                <table class="spec-table">
                    <tbody>
                        ...
                        <tr>
                            <th>Category</th>
                            <td><?php echo e($product->category_name ?? 'General Goods'); ?></td>
                        </tr>
                        ...
                        <?php endif; ?>
                        <?php if($product->sourcing_country): ?>
                        <tr>
                            <th>Sourcing / Origin</th>
                            <td><?php echo e($product->sourcing_country); ?></td>
                        </tr>
                        <?php endif; ?>
                        <?php $__currentLoopData = $specsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specKey => $specVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(!in_array($specKey, ['Brand', 'Dimensions', 'Sourcing Country'])): ?>
                            <tr>
                                <th><?php echo e($specKey); ?></th>
                                <td><?php echo e(is_array($specVal) ? implode(', ', $specVal) : $specVal); ?></td>
                            </tr>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <th>Stock Status</th>
                            <td><?php echo e($product->available_stock > 0 ? $product->available_stock . ' units ready to dispatch' : 'In Stock (Ready to ship)'); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($product->is_natural_lighting_declared ? 'Yes (Color-accurate real footage)' : 'Standard Studio Condition'); ?></td>
                        </tr>
                        <tr>
        ...
        <div class="tab-pane-content" id="tab-reviews">
            <div class="reviews-summary-grid">
                <div class="big-score-box">
                    <div class="big-score-num"><?php echo e($displayAvgRating); ?></div>
                    ...
                    <div style="font-size: 0.85rem; color: var(--p-text-muted);">Based on <?php echo e(number_format($displayReviewsCount)); ?> verified reviews</div>
                </div>
                ...
                <div class="rating-bars-list">
                    <?php for($s = 5; $s >= 1; $s--): ?>
                        <div class="bar-row">
                            ...
                            <div class="bar-track"><div class="bar-fill" style="width: <?php echo e($ratingPercents[$s] ?? 0); ?>%;"></div></div>
                            <span><?php echo e($ratingPercents[$s] ?? 0); ?>%</span>
                        </div>
                    <?php endfor; ?>
                </div>
            </div>
                        ...
                        <div class="review-card-item">
                            <div class="review-card-header">
                                <div class="reviewer-info">
                                    <img src="<?php echo e($review->user && $review->user->avatar_url ? $review->user->avatar_url : 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=80&auto=format&fit=crop&q=80'); ?>" alt="<?php echo e($review->user ? $review->user->name : ($review->author_name ?? 'Customer')); ?>" class="reviewer-avatar">
                                    <div>
                                        <div class="reviewer-name"><?php echo e($review->user ? $review->user->name : ($review->author_name ?? 'Customer')); ?> <span class="badge bg-success text-white" style="font-size: 0.68rem;">Verified Buyer</span></div>
                                ...
                                <span class="review-date-text"><?php echo e($review->created_at ? $review->created_at->diffForHumans() : 'Recently'); ?></span>
                            </div>
            ...
            <div class="write-review-box">
                ...
                <form id="submitReviewForm" onsubmit="handleReviewSubmit(event)">
                    <div class="row g-2">
                        <div class="col-md-6">
                            <input type="text" class="form-review-input" placeholder="Your Name" id="reviewAuthorName" value="<?php echo e(auth()->check() ? auth()->user()->name : ''); ?>" required>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div style="background: #090D10; border: 1px solid var(--p-card-border); border-radius: 14px; padding: 22px;">
                        ...
                        <ul style="color: #CBD5E1; font-size: 0.88rem; line-height: 1.8; padding-left: 20px; margin: 0;">
                            <li><strong>Standard Shipping:</strong> 2-4 business days (Free over <?php echo e($currency); ?>50).</li>
                            <li><strong>Express Shipping:</strong> 1-2 business days (+<?php echo e($currency); ?>25.00).</li>
    ...
    <?php if(isset($relatedProducts) && $relatedProducts->count() > 0): ?>
        <section class="related-products-section">
            <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                <a href="<?php echo e(route('shop.index')); ?>" class="btn-link-live-room">View All Products <i class="bi bi-arrow-right"></i></a>
            </div>
            ...
            <div class="grid-4-products">
                <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="product-static-card">
                        <a href="<?php echo e(route('shop.product', $rel->id)); ?>" class="static-card-img-wrap">
                            <img src="<?php echo e($rel->primary_image); ?>" alt="<?php echo e($rel->title); ?>">
                        </a>
                        <div class="static-card-body">
                            <span class="product-badge-cat mb-2" style="align-self: flex-start;"><?php echo e($rel->category_name ?? 'Product'); ?></span>
                            <a href="<?php echo e(route('shop.product', $rel->id)); ?>" class="static-card-title"><?php echo e(Str::limit($rel->title, 26)); ?></a>
                            <div class="static-card-price-row">
                                <span class="static-card-price"><?php echo e($currency); ?><?php echo e(number_format($rel->price, 2)); ?></span>
                                <button type="button" class="btn-quick-add" title="Add To Cart" onclick="handleAddToCart(<?php echo e($rel->id); ?>)">
...
<div class="cart-toast-notification" id="cartToastNotification">
    <img src="<?php echo e($mainImg); ?>" alt="Cart Item" id="toastItemImg" class="toast-img">
    <div class="toast-text-box">
        <h4 id="toastItemTitle">Item Added to Cart!</h4>
        <p id="toastItemMeta">1x &bull; <?php echo e($defaultColor); ?> &bull; <?php echo e($defaultSize); ?></p>
    </div>
    <a href="<?php echo e(route('shop.cart')); ?>" class="toast-btn-cart">View Cart &rarr;</a>
</div>
...
<footer class="zal-footer-center">
    <div class="container">
        ...
        <div class="footer-copyright-line">
            &copy; <?php echo e(date('Y')); ?> <?php echo e(setting('site_name', 'Zaldoris Live Commerce')); ?>. All rights reserved.
        </div>
    </div>
</footer>
...
<script>
    /* ========================================================
       ...
       ======================================================== */
    const productData = {
        id: <?php echo e($product->id ?? 1); ?>,
        title: <?php echo json_encode($product->title ?? 'Product Details', 15, 512) ?>,
        currency: '<?php echo e($currency); ?>',
        basePrice: <?php echo e((float) $price); ?>,
        unitPrice: <?php echo e((float) $defaultSizePrice); ?>,
        oldPrice: <?php echo e((float) $comparePrice); ?>,
        selectedSize: <?php echo json_encode($defaultSize, 15, 512) ?>,
        selectedColor: <?php echo json_encode($defaultColor, 15, 512) ?>,
        quantity: 1,
        image: '<?php echo e($mainImg); ?>',
        seller: '<?php echo e($sellerName); ?>'
    };
    ...
    function handleReviewSubmit(e) {
        ...
        fetch('<?php echo e(route("shop.product.review", $product->id ?? 1)); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
...
<?php /**PATH C:\wamp64\www\zaldoris-tiktok\resources\views/shop/product-details.blade.php ENDPATH**/ ?>